...
<html>
	...
	<div id="page-wrapper" class="gray-bg dashboard"  style="padding-bottom:20px">
		<div class="row">
			...
			<div class="box-container" style="width:45%;">
                                <div class="box">
                                        <div class="box-title">
			...
			<div class="box-container" style="width:33%;">
                                <div class="box">
                                        <div class="box-title">
...
//            var MacquarieBogan_unregulated = MacquarieBogan_unregulated;
            ...
            for (j = 0; j < lgas.features.length; j++) {
                    ...
                    lgas.features[j].properties.FUI1=0;
            ...
            d3.csv("data/FUI.csv", function (data) {
                    _.each(data, function (d, i) {
                            ...
                            lgaDict[water_source_name].properties.FUI1=d.FUI1;
