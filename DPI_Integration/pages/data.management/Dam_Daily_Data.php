            ...
            <table class="layui-table">
                <thead>
                    <tr>
                        ...
                        <th>dam_name</th>
                        <th>day</th>
                        <th>daily_storage_volume</th>
                        <th>daily_regulated_releases</th>
                        <th>daily_spill_volume</th>
                    <tr>
                </thead>
                <tbody>
                <?php
                    ...
                    $result=mysqli_query($conn,"SELECT * FROM dam_daily_data");  
                    ...
                    for($i=0;$i<$dataCount;$i++){  
                        ...
                        $day=$result_arr['day']; 
                        $daily_storage_volume=$result_arr['daily_storage_volume'];
                        $daily_regulated_releases=$result_arr['daily_regulated_releases'];
                        $daily_spill_volume=$result_arr['daily_spill_volume'];
                        echo "<tr>"
                                . "<td>$row_id</td>"
                                . "<td>$dam_name</td>"
                                . "<td>$day</td>"
                                . "<td>$daily_storage_volume</td>"
                                . "<td>$daily_regulated_releases</td>"
                                . "<td>$daily_spill_volume</td>"
                            . "<tr>";
                    }
                ?>
                </tbody>
                ...
                req.onreadystatechange = function() {
                    if(req.readyState === 4 && req.status === 200) {
                        if(this.responseText=="1"){
                            window.open("../../files/export.files/dam_daily_data.csv");
                        }else{
