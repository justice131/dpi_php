    ...
    <body>
        <div class="x-nav">
            <span class="layui-breadcrumb">
              ...
              <a><cite>Valley Yearly Data</cite></a>
            </span>
        </div>
        <div class="x-body">
          <div tabindex="300" class="btn btn-info btn-lg btn-file" >
            ...
            <table class="layui-table">
                ...
                <?php
                    ...
                    $result=mysqli_query($conn,"SELECT * FROM valley_yearly_data");  
                    ...
                    for($i=0;$i<$dataCount;$i++){  
                        ...
                        $balance=$result_arr['balance'];
                        $diversion=$result_arr['diversion'];
                        $carry_over=$result_arr['carry_over'];
                        echo "<tr>"
                                . "<td>$row_id</td>"
                                . "<td>$valley_name</td>"
                                . "<td>$year</td>"
        ...
        <script>
            function delete_table(){
                ...
                if (r==true){
                    ...
                    xhttp.open("POST", "../../tools/db_table_delete.php?table_name=valley_yearly_data", true);
                    xhttp.send();
                }
            }
            ...
            function import_data(files){
                ...
                req.open("POST", '../../tools/db_table_import.php?table_name=valley_yearly_data', true);
                req.send(form);
            }
                ...
                req.onreadystatechange = function() {
                    if(req.readyState === 4 && req.status === 200) {
                        if(this.responseText=="1"){
                            window.open("../../files/export.files/valley_yearly_data.csv");
                        }else{
                            alert("Fail to output the table.");
                        }
                    }
                };
                req.open("POST", '../../tools/db_table_output.php?table_name=valley_yearly_data', true);
                req.send();
            }
        </script>            
    </body>
