...
<html>
    <head>
        <title>Irrigation Data Insight of Manning</title>
...
//            map.fitBounds(Mac_unregulated.getBounds());
            ...
            function show_s1(id){
                    ...
                    var max_row=0;//Get the row number of ranking file
                        d3.csv("data/FUI_irrigation_area_potential_man.csv", function (data) {
                    ...
                    document.getElementById('s0_title').innerHTML = '<span style="font-size:18px; font-weight:bold; margin-bottom: 0; height: 48px;">'+'Water Source of Manning Catchment--Opportunity for irrigation'+'</span>';
...
//                    var geojson, geojsonLabels;
            ...
            function show_s2(id){
                    ...
                    var max_row=0;//Get the row number of ranking file
                        d3.csv("data/days_below_mean_agriculture_production_man.csv", function (data) {
                        _.each(data, function (d, i) {
                        max_row++;
                    ...
                    var checkBox = document.getElementById(id); 
                    if (checkBox.checked === true){
                    document.getElementById('s0_title').innerHTML = '<span style="font-size:18px; font-weight:bold; margin-bottom: 0; height: 48px;">'+'Water Source of Manning Catchment--Risk to agriculture due to variation in supply availability'+'</span>';
...
//                    var geojson, geojsonLabels;
            ...
            function show_s3(id){
                    ...
                    var max_row=0;//Get the row number of ranking file
                        d3.csv("data/DSI_agriculture_production_man.csv", function (data) {
                        _.each(data, function (d, i) {
                        max_row++;
                    ...
                    var checkBox = document.getElementById(id); 
                    if (checkBox.checked === true){
                    document.getElementById('s0_title').innerHTML = '<span style="font-size:18px; font-weight:bold; margin-bottom: 0; height: 48px;">'+'Water Source of Manning Catchment--Risk to agricultural productivity from lack of water'+'</span>';
...
//                    var geojson, geojsonLabels;
            ...
            function show_s4(id){
                    ...
                    var max_row=0;//Get the row number of ranking file
                        d3.csv("data/Flood_risk_man.csv", function (data) {
                        _.each(data, function (d, i) {
                        max_row++;
