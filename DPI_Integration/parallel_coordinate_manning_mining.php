...
<html>
    <head>
        <title>Mining Data Insight of Manning</title>
...
//            map.fitBounds(Mac_unregulated.getBounds());
            ...
            function show_s1(id){
                    ...
                    var max_row=0;//Get the row number of ranking file
                        d3.csv("data/DSI_mine_production_man.csv", function (data) {
                    ...
                    document.getElementById('s0_title').innerHTML = '<span style="font-size:18px; font-weight:bold; margin-bottom: 0; height: 48px;">'+'Water Source of Manning Catchment--Risk to mining productivity from lack of water'+'</span>';
                    ...
                    d3.csv("data/DSI_mine_production_man.csv", function (data) {
                        var keys = Object.keys(data[0]);
                            _.each(data, function (d, i) {
                                    ...
                                    lgaDict[water_source_name].properties.DSI_mine_production=d[keys[21]];
