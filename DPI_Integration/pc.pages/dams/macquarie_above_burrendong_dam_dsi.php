...
<html>
    <head>
        <title>Macquarie Above Burrendong DSI</title>
		...
		<div class="row">
			<div class="box-container" style="width:22%;" id="map_panel">
				<div class="box">
					<div class="box-title">
                                            <div id="s0_title">
                                                <span style="font-size:18px; font-weight:bold; margin-bottom: 0; height: 48px;">Water Source of Burrendong--Risk to catchment due to drought</span>
                                            </div>
					</div>
            ...
            d3.csv("../../pc.csv/macquarie_above_burrendong_dam.csv", function (data) {
                var keys = Object.keys(data[0]);
                    ...
                    legend.onAdd = function (map) {
                            ...
                            labels = [],
                            from, to;
                            labels.push('<i style="background:' + myCols[0] + '"></i> ' + '[0, 0.3]');
                            labels.push('<i style="background:' + myCols[1] + '"></i> ' + '(0.3, 0.55]');
                            labels.push('<i style="background:' + myCols[2] + '"></i> ' + '(0.55, 1]');
