		...
		<div class="row">
			<div class="box-container" style="width:22%;" id="map_panel">
				<div class="box">
					<div class="box-title">
                                            <div id="s0_title">
                                                <span style="font-size:18px; font-weight:bold; margin-bottom: 0; height: 48px;">Water Sources of Burrendong--Opportunity for additional supply</span>
                                            </div>
					</div>
            ...
            d3.csv("../../pc.csv/macquarie_above_burrendong_dam.csv", function (data) {
                var keys = Object.keys(data[0]);
                    ...
                    legend.onAdd = function (map) {
                            ...
                            labels = [];
                            labels.push('<i style="background:' + myCols[2] + '"></i> ' + '[0, 0.2]');
                            labels.push('<i style="background:' + myCols[1] + '"></i> ' + '(0.2, 0.4]');
                            labels.push('<i style="background:' + myCols[0] + '"></i> ' + '(0.4, 1]');
                    ...
                    parcoords.on("brush", function (d) {
                            ...
                            gridUpdate(d);
                            //update map
                            lgas.features.map(function (d) {d.properties.FUI = -100; });
