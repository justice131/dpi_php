...
<html>
    <head>
        <title>Macquarie Above Upper Talbragar DSI</title>
		...
		<div class="row">
			<div class="box-container" style="width:22%;" id="map_panel">
				<div class="box">
					<div class="box-title">
                                            <div id="s0_title">
                                                <span style="font-size:18px; font-weight:bold; margin-bottom: 0; height: 48px;">Water Sources of Upper Cudgegong--Water risk due to drought</span>
                                            </div>
					</div>
