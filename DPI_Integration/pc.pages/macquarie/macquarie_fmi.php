            ...
            <div class="row">
                <div class="box-container" style="width:22%;" id="map_panel">
                    <div class="box">
                        <div class="box-title">
                            <div id="s0_title">
                                <span style="font-size:18px; font-weight:bold; margin-bottom: 0; height: 48px;">Water Source of Macquarie Catchment--Flood risk (100 years return period)</span>
                            </div>
                        </div>
...
//                                            'Water Scarcity: '+ '<b>'+ toThousands(props.water_scarcity) + '</b>'+'<br />'+
                                    'Flood Risk Index (FRI): ' + '<b>'+ Math.round(props.flood_risk*100*10)/10 + ' %</b>'+'<br />'
