	...
	<div id="page-wrapper" class="gray-bg dashboard"  style="padding-bottom:20px">
            <div class="row">
                <div class="box-container" style="width:22%;" id="map_panel">
                    <div class="box">
                        <div class="box-title">
                            <div id="s0_title">
                                <span style="font-size:18px; font-weight:bold; margin-bottom: 0; height: 48px;">Water Sources of Macquarie Catchment--100 years flood risk</span>
                            </div>
                        </div>
        ...
        <script type="text/javascript">
            ...
            parcoords = d3.parcoords()("#parrallel_coordinate")
                    ...
                    .color(function (d) { 
                        return getColorScalar(d["FRI (100 yrs Flood Frequency) (%)"])
                    });
            ...
            d3.csv("../../pc.csv/fmi_macquaire.csv", function (data) {
                    ...
                    column_keys.length = 9; //remove index
                                    ...
                                    geojsonLabels.getLayers().forEach(function (z) {
                                            if (z.feature.properties.name == d.feature.properties.WATER_SOUR) {
                                                    if (d.feature.properties.flood_risk >= 0) {
                                                            z._icon.innerHTML=Math.round(d.feature.properties.flood_risk*100)/100 + '%';
                                                    } else {
                                                            z._icon.innerHTML = "";
                                                    }
                                            }
