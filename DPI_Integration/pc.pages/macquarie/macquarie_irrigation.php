        ...
        <div class="row" style="width: 100%;">
            <div class="box-container" style="width:17%;">
                <div class="box">
                    <div class="box-title">
                        <div>
                            <span style="font-size:18px; font-weight:bold; margin-bottom: 0; height: 48px;">Water Source of Macquarie Catchment--Opportunity for irrigation</span>
                        </div>
                    </div>
            ...
            <div class="box-container" style="width:17%;">
                <div class="box">
                    <div class="box-title">
                        <div>
                            <span style="font-size:18px; font-weight:bold; margin-bottom: 0; height: 48px;">Water Source of Macquarie Catchment--Risk to agriculture due to variation in supply availability</span>
                        </div>
                    </div>
                    <div class="box-content" style="padding: 10px 10px 10px 20px;">
                        <div id="map2"></div>
...
//                        'Opportunity Array: '+ '<b>'+ props.irrigation_opportunity_sequence + '</b>'+'<br />'+
...
//                                            'Water Scarcity: '+ '<b>'+ toThousands(props.water_scarcity) + '</b>'+'<br />'+
            ...
            for (j = 0; j < lgas.features.length; j++) {
                ...
                lgas.features[j].properties.irrigation_risk_sequence=new Array();
                lgas.features[j].properties.irrigation_opportunity_sequence=new Array();
