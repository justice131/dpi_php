...
<html>
    <head>
        <title>Manning Irrigation</title>
    ...
    <body style="background-color:#F3F3F4;">
        <div class="row" style="width: 100%;">
            <div class="box-container" style="width:17%;">
                <div class="box">
                    <div class="box-title">
                        <div>
                            <span style="font-size:18px; font-weight:bold; margin-bottom: 0; height: 48px;">Water Sources of Manning Catchment--Opportunity for irrigation ($M)</span>
                        </div>
                    </div>
            ...
            <div class="box-container" style="width:17%;">
                <div class="box">
                    <div class="box-title">
                        <div>
                            <span style="font-size:18px; font-weight:bold; margin-bottom: 0; height: 48px;">Water Sources of Manning Catchment--Risk to agriculture due to variation in supply availability ($M)</span>
                        </div>
                    </div>
                    <div class="box-content" style="padding: 10px 10px 10px 20px;">
                        <div id="map2"></div>
        ...
        <script type="text/javascript">
           ...
           //map1
            ...
            d3.csv("../../pc.csv/irrigation_manning.csv", function (data) {
                ...
                function style1(feature) {
                    return {
                        ...
                        color: 'white',
                        dashArray: '3',
                        fillOpacity: 0.8 * showIt(feature.properties.irrigation_opportunity_index),
                ...
                function style2(feature) {
                    return {
                        ...
                        color: 'white',
                        dashArray: '3',
                        fillOpacity: 0.8 * showIt(feature.properties.agricluture_risk_index),
                ...
                function refreshMap(updatedLGA) {
                    ...
                    geojson2.getLayers().map(function (d) {
                        ...
                        geojsonLabels2.getLayers().forEach(function (z) {
                            if (z.feature.properties.name == d.feature.properties.WATER_SOUR) {
                                if (d.feature.properties.agricluture_risk_index >= 0) {
            ...
            d3.csv("../../pc.csv/irrigation_risk_history_manning.csv", function (data) {
            ...
            d3.csv("../../pc.csv/irrigation_opportunity_history_manning.csv", function (data) {
                var keys = Object.keys(data[0]);
                _.each(data, function (d, i) {
                    d.index = d.index || i; //unique id
                    var water_source_name = d["Water Sources"];
