...
<html>
    <head>
        <title>Manning Potential Need</title>
    ...
    <body style="background-color:#F3F3F4;">
        <div class="row" style="width: 6500px;">
            <div id="map_panel" class="box-container" style="width:20%;" >
                <div class="box">
                    <div class="box-title">
                        <div id="s0_title">
                            <span style="font-size:18px; font-weight:bold; margin-bottom: 0; height: 48px;">Water Sources of Manning Catchment--Potential need for new infrastructure</span>
                        </div>
                    </div>
        ...
        <script type="text/javascript">
            ...
            var Man_unregulated = L.geoJSON(lgas, {
            ...
            d3.csv("../../pc.csv/potential_for_new_infrastucture_manning.csv", function (data) {
