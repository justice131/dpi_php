		...
		L.tileLayer('https://api.tiles.mapbox.com/v4/{id}/{z}/{x}/{y}.png?access_token=' + myToken, {
            ...
            function show_s1(id){
                ...
                if (checkBox.checked === true){
                    document.getElementById('s0_title').innerHTML = '<span style="font-size:18px; font-weight:bold; margin-bottom: 0; height: 48px;">'+'Town Water Supply Insight for Macquarie Catchment--Water supply deficiency index'+'</span>';
            ...
            function show_s2(id){
                var checkBox = document.getElementById(id); 
                if (checkBox.checked === true){
                    document.getElementById('s0_title').innerHTML = '<span style="font-size:18px; font-weight:bold; margin-bottom: 0; height: 48px;">'+'Town Water Supply Insight for Macquarie Catchment--Water supply risk'+'</span>';
                    var elem_ov = document.createElement("div");
                    elem_ov.setAttribute('id', 'tws_legend');
                    elem_ov.innerHTML = (
